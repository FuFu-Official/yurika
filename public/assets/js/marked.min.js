...
`),
            ...
            && ((T = this.rules.other.listIsTask.exec(c)),
              T
              && ((ee = T[0] !== "[ ] "), (c = c.replace(this.rules.other.listReplaceTask, "")))),
              i.items.push({
                type: "list_item",
                raw: p,
                task: !!T,
          ...
          for (let u = 0; u < i.items.length; u++) {
            if (
              ((this.lexer.state.top = !1), (i.items[u].tokens = this.lexer.blockTokens(i.items[u].text, [])), !i.loose)
            ) {
      ...
      codespan(e) {
        ...
        if (t) {
          let n = t[2].replace(this.rules.other.newLineCharGlobal, " "),
            ...
            i = this.rules.other.startingSpaceChar.test(n)
          ...
          e.forEach((n) => {
            ...
            if (n.walkTokens) {
              ...
              r.walkTokens = function(o) {
                let l = [];
                return (
                  l.push(s.call(this, o)), i && (l = l.concat(i.call(this, o))), l
                );
              };
            }
