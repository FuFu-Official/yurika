    ...
    static _walk(e, n) {
      return (
        "string" == typeof n
          ? e.addText(n)
          : n.children
            && (e.openNode(n), n.children.forEach((n) => o._walk(e, n)), e.closeNode(n)), e
      );
    }
    static _collapse(e) {
      "string" != typeof e
  ...
  function Q(e) {
    ...
    class i {
      ...
      exec(e) {
        ...
        return (
          t
          && ((this.regexIndex += t.position + 1), this.regexIndex === this.count && this.considerAll()), t
        );
      }
    }
    if (
  ...
  const J = t,
    ...
    ne = (t) => {
        ...
        function c() {
          ...
          for (; n;) {
            ...
            if (r) {
              const [e, a] = r;
              if (
                (S.addText(t), (t = ""), (l[i] = (l[i] || 0) + 1), l[i] <= 7 && (C += a), e.startsWith("_"))
              ) {
                t += n[0];
              } else {
      ...
      function y(e) {
        ...
        if (_(t)) return;
        if (
          (x("before:highlightElement", { el: e, language: t }), e.dataset.highlighted)
        ) {
  ...
  var Ke = Object.freeze({
    ...
    grmr_kotlin: (e) => {
      ...
      const s = {
        ...
        g = d;
      return (
        (g.variants[1].contains = [d]), (d.variants[1].contains = [g]), {
          name: "Kotlin",
          aliases: ["kt", "kts"],
          keywords: n,
          contains: [
    ...
    grmr_perl: (e) => {
      ...
      return (
        (i.contains = g), (r.contains = g), { name: "Perl", aliases: ["pl", "pm"], keywords: a, contains: g }
      );
    },
    grmr_php: (e) => {
      const n = e.regex,
