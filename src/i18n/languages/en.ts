...
export const en: Translation = {
  ...
  [Key.bookEmptyBangumi]: "Please check Bangumi configuration or network connection",
  [Key.bookEmptyLocal]: "Please add book information in src/data/book.ts file",
  ...
  [Key.gameEmptyBangumi]: "Please check Bangumi configuration or network connection",
  [Key.gameEmptyLocal]: "Please add game information in src/data/game.ts file",
