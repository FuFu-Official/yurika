...
export const zh_TW: Translation = {
  ...
  [Key.gamePlatform]: "平台",
  [Key.gamePlaytime]: "遊玩時間",
  [Key.gameEmpty]: "暫無遊戲數據",
  [Key.gameEmptyBangumi]: "請檢查 Bangumi 配置或網絡連接",
  [Key.gameEmptyLocal]: "請在 src/data/games.ts 檔案中添加遊戲資訊",
