...
export const siteConfig: SiteConfig = {
	title: "Yurika",
	subtitle: "Personal Blog Powered by Mizuki",
	siteURL: "https://yur1ka.netlify.app/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-10-29", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "sakurayur1", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	game: {
		mode: "bangumi", // 游戏页面模式："bangumi" 使用Bangumi API，"local" 使用本地配置
	},
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "Welcome to my blog! All content on this site is provided for learning and communication purposes only.", // 公告内容
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "api_p8ibr9MESWUxFMNQxKk5WRXgFMlI71sj", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="a2eabb15-f42f-4feb-aefa-675649d03f90"></script>
